...
namespace CozyHavenStayServer.Context.ModelConfig
{
    public class HotelConfig : IEntityTypeConfiguration<Hotel>
    {
        public void Configure(EntityTypeBuilder<Hotel> builder)
        {
            ...
            builder.Property(h => h.HotelId).HasColumnName("HotelId").HasColumnType("int").IsRequired();
            builder.Property(h => h.OwnerId).HasColumnName("OwnerId").HasColumnType("int").IsRequired();
            builder.Property(h => h.Name).HasColumnName("Name").HasColumnType("nvarchar(255)").IsRequired();
            builder.Property(h => h.Location).HasColumnName("Location").HasColumnType("nvarchar(255)").IsRequired();
