...
namespace CozyHavenStayServer.Migrations
{
    ...
    [Migration("20240229133816_paymentMig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CozyHavenStayServer.Models.Payment", b =>
                {
                    b.Property<int>("PaymentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CozyHavenStayServer.Models.Refund", b =>
                {
                    b.Property<int>("RefundId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CozyHavenStayServer.Models.Payment", b =>
                {
                    b.HasOne("CozyHavenStayServer.Models.Booking", "Booking")
                        .WithOne("Payment")
                        .HasForeignKey("CozyHavenStayServer.Models.Payment", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("CozyHavenStayServer.Models.Refund", b =>
                {
                    b.HasOne("CozyHavenStayServer.Models.Payment", "Payment")
                        .WithOne("Refund")
                        .HasForeignKey("CozyHavenStayServer.Models.Refund", "PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
